...
// MODAL PROFESIONAL: solo muestra botones
...
// Abrir formularios de ingresar o registrar
...
document.getElementById('abrir-form-registrar').onclick = function() {
  ...
  document.getElementById('error-registrar-profesional').style.display = 'none';
};
...
document.getElementById('form-registrar-profesional').onsubmit = async function(e) {
  e.preventDefault();
  ...
  const errorDiv = document.getElementById('error-registrar-profesional');
  ...
  auth.createUserWithEmailAndPassword(correo, clave)
    .then(async (userCredential) => {
      ...
      await db.collection("usuarios").doc(usuarioUid).set({ 
        profesion: profesionActual,
